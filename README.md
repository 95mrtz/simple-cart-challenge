...
Este proyecto es propuesto por [Goncy](https://twitter.com/goncy) en su [repositorio de challenge](https://github.com/goncy/interview-challenges/tree/main/simple-cart)

El sitio fue deployado en Vercel : [Live site]()
